...
from lab5_wnet import *
from lab5_util import *
...
class WirelessNode:
    ...
    def transmit_done(self, packet):
        self.transmitting = False
        if packet.coll_flag == lab5_wnet.COLLISION:
            self.stats.collisions += 1
            # Note: For TDMA, don't remove packet (shd never happen)
            if (self.retry == lab5_wnet.NO_RETRY and
    ...
    def net2screen(self, transform):
        return lab5_wnet.net2screen(self.location, transform)
